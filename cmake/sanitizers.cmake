...
if(BML_BUILD_COVERAGE)
  ...
  add_custom_target(CollectCoverage
    COMMAND lcov --quiet --base-directory ${PROJECT_SOURCE_DIR} --directory . --exclude ${PROJECT_BINARY_DIR} --exclude ${PROJECT_SOURCE_DIR}/test --no-external --capture --ignore-errors unused --output-file Testing/coverage.info
