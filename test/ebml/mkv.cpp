...
public:
  ...
  void testInfo() {
    ...
    testElement(elem,
                {0x15, 0x49, 0xA9, 0x66, 0x41, 0x1B, 0xBF, 0x84, 0xD1, 0xF5, 0xC5, 0x8A, 0x73, 0xA4, 0x90, 0x92, 0xB2,
...
contentCompression:
  ...
  void testTrackEntry() {
    ...
    testElement(elem, {0xAE, 0xEB, 0xBF, 0x84, 0x84, 0x09, 0xC1, 0x50, 0xD7, 0x81, 0x01, 0x73, 0xC5, 0x84, 0x6F, 0x1A,
...
video:
  ...
  void testTracks() {
    Tracks elem{};
    elem.crc32 = 0xF5EEDF23;

    {
      TrackEntry entry{};
      entry.crc32 = 0x8409C150;
      entry.trackNumber = 1;
    ...
    testElement(elem,
                {0x16, 0x54, 0xAE, 0x6B, 0xBE, 0xBF, 0x84, 0xF5, 0xEE, 0xDF, 0x23, 0xAE, 0xB6, 0xBF, 0x84, 0x84, 0x09,
                 0xC1, 0x50, 0xD7, 0x81, 0x01, 0x73, 0xC5, 0x84, 0x6F, 0x1A, 0x06, 0xB3, 0x83, 0x81, 0x01, 0x9C, 0x81,
...
simpleTags:
  ...
  void testTags() {
    ...
    testElement(elem, {0x12, 0x54, 0xC3, 0x67, 0xA6, 0xBF, 0x84, 0x71, 0x65, 0x20, 0x1C, 0x73, 0x73, 0x9D, 0x63,
...
cueTrackPositions:
  ...
  void testCues() {
    ...
    testElement(elem, {0x1C, 0x53, 0xBB, 0x6B, 0x91, 0xBF, 0x84, 0x49, 0x44, 0xEE, 0x4D,
...
blockGroups:
  ...
  void testSegment() {
    ...
    {
      SeekHead head{};
      head.crc32 = 0xCAC96652;
      Seek seek{};
      seek.crc32 = 0x24EC36F7;
      seek.seekID = toBytes({0x12, 0x54, 0xC3, 0x67});
    ...
    {
      Tracks tracks{};
      tracks.crc32 = 0xFF31C584;

      TrackEntry entry{};
      entry.crc32 = 0x2621AB68;
    ...
    testElement<Segment, true /* content */>(
        ...
        {0x18, 0x53, 0x80, 0x67, 0x41, 0x1D,
         /* Seekhead */
         0x11, 0x4D, 0x9B, 0x74, 0x9B, /* CRC32 */ 0xBF, 0x84, 0xCA, 0xC9, 0x66, 0x52,
         /* Seek */
         ...
         /* Tracks */
         0x16, 0x54, 0xAE, 0x6B, 0xD3, /* CRC32 */ 0xBF, 0x84, 0xFF, 0x31, 0xC5, 0x84,
         /* TrackEntry */
         0xAE, 0xA7, /* CRC32 */ 0xBF, 0x84, 0x26, 0x21, 0xAB, 0x68,
         ...
         /* TrackEntry */
         0xAE, 0xA2, /* CRC32 */ 0xBF, 0x84, 0xE9, 0x11, 0xBF, 0x89,
         ...
         /* Cues */
         0x1C, 0x53, 0xBB, 0x6B, 0x97, /* CRC32 */ 0xBF, 0x84, 0x1B, 0x34, 0x40, 0x2B,
         /* CuePoint */
